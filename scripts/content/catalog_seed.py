...
AWH_SECTIONS = [
    ...
    section("24", 24, "Surface Observations and METAR/SPECI", 1, 25, ["Observation systems and quality control", "METAR/SPECI format", "Wind, visibility, and runway visual range", "Weather, sky condition, and ceiling", "Temperature, altimeter, and remarks"], ["PA.I.C.K3", "PA.I.C.R2"]),
    section("24b", 24, "Aircraft and Radar Observations", 26, 44, ["Pilot weather reports", "Automated aircraft reports", "Weather radar observations", "Lightning detection", "Observation latency and limitations"], ["PA.I.C.K3", "PA.I.C.R2"]),
    section("24c", 24, "Satellite and Upper-Air Observations", 45, 58, ["Visible, infrared, and water-vapor imagery", "Soundings and upper-air observations", "Weather cameras", "Buoy, ship, and remote observations", "Weather-camera trends and observation limitations"], ["PA.I.C.K3", "PA.I.C.R2"]),
    ...
    section("26", 26, "SIGMET, AIRMET, and CWA", 1, 22, ["Advisory purpose and issuance", "SIGMET criteria", "Convective SIGMET", "AIRMET and G-AIRMET", "Center Weather Advisory"], ["PA.I.C.K3", "PA.I.C.R2"]),
    section("26b", 26, "Specialized and Local Advisories", 23, 34, ["Volcanic ash advisories", "Tropical cyclone advisories", "Space-weather advisories", "Low-level wind-shear alerts", "Local warnings and airport weather alerts"], ["PA.I.C.K3", "PA.I.C.R2"]),
